...
stemmer = SnowballStemmer("english")	# SnowballStemmer Object
...
def getNorm(doc):						
	...
	"""
	s=linecache.getline("norm.txt",int(doc)+1)
...
def SQRT(doc):
	...
	for term in univ_dict:
		for List in univ_dict[term]:
			if List[0] == doc:
				sim += ((float(List[2]) * IGFL(term)) / norm) * qVector[i]
				i +=1
				break
	return sim
...
print "		#############################################################"
print "		#  VMARK v1.0.0 Syntactic VSM Information Retrieval System  #"
print "		#############################################################"
print "\n\n"
...
if len(docVectorList) == 0:
	...
	print "Relevant docs related to your query are:" 
